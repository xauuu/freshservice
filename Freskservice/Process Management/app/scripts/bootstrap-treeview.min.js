!(function (a, b, c, d) {
    ...
    (g.prototype.init = function (b) {
                ...
                a.each(b.nodes, function (a, b) {
                    (b.nodeId = e.nodes.length),
                        ...
                        b.state.hasOwnProperty("expanded") ||
                            (!b.state.disabled && c < e.options.levels && b.nodes && b.nodes.length > 0 ? (b.state.expanded = !0) : (b.state.expanded = !1)),
        ...
        (g.prototype.setCheckedState = function (b, c, d) {
            c !== b.state.checked &&
                (c
                    ? ((b.state.checked = !0), d.silent || this.$element.trigger("nodeChecked", a.extend(!0, {}, b)))
                    : ((b.state.checked = !1), d.silent || this.$element.trigger("nodeUnchecked", a.extend(!0, {}, b))));
        }),
        ...
        (g.prototype.buildTree = function (b, c) {
            if (b) {
                ...
                a.each(b, function (b, e) {
                    ...
                    if (
                        (e.nodes
                            ? (h.push("expand-icon"), h.push(e.state.expanded ? d.options.collapseIcon : d.options.expandIcon))
        ...
        (g.prototype.buildStyleOverride = function (a) {
            ...
            return (
                this.options.highlightSelected &&
                    a.state.selected &&
                    (this.options.selectedColor && (b = this.options.selectedColor), this.options.selectedBackColor && (c = this.options.selectedBackColor)),
        ...
        (g.prototype.injectStyle = function () {
            this.options.injectStyle &&
                ...
                a('<style type="text/css" id="' + this.styleId + '"> ' + this.buildStyle() + " </style>").appendTo("head");
        }),
        (g.prototype.buildStyle = function () {
            ...
            return (
                ...
                this.options.onhoverColor &&
                    (a += ".node-" + this.elementId + ":not(.node-disabled):hover{background-color:" + this.options.onhoverColor + ";}"),
                this.css + a
            );
        }),
